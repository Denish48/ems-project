...
const AddSurvey = (props) => {
    ...
    const handleSubmit = async (questions, name) => {
        try {
            ...
            const response = await Service.makeAPICall({
                ...
                api_url: Service.addElevateForms,
                body: {
                    name,
                    questions,
    ...
    const handleFormName = (values) => {
        handleSubmit(formData, values?.elevate_form_name);
    }
        ...
        <>
            ...
            >
                <Form
                    ...
                    {...formItemLayout}
                    form={form}
                    onFinish={handleFormName}
                >
                    <Form.Item
                        label="Elevate Form Template Name"
                        name="elevate_form_name"
                        rules={[
                            {
                                required: true,
